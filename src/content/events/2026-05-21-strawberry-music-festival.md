...
Our open hours run inside the festival and can shift with the music schedule, so check back for confirmed times before you visit. Look for the railroad building inside the fairgrounds.
...
For the official lineup, schedule, ticketing, and camping details, see Strawberry Music, Inc.
